...
class MapsActivity : FragmentActivity(), OnMapReadyCallback {
    ...
    override protected fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (i in 0..smokerLocations.size() - 1) {
            //draws spots to map
            val marker = LatLng(smokerLocations.get(i).latitude, smokerLocations.get(i).longitude)
    ...
    inner class GetSmokationsRequest : AsyncTask<String, Void, ArrayList<Smokation>>() {
        ...
        override protected fun doInBackground(vararg params: String): ArrayList<Smokation> {
